...
struct HfTaskSingleElectron {
  ...
  Configurable<int> nClsTpcMin{"nClsTpcMin", 0, "min # of found TPC clusters (0 = off)"};
  Configurable<int> nClsItsMin{"nClsItsMin", 0, "min # of total ITS clusters (0 = off)"};
  ...
  void init(InitContext const&)
  {
    ...
    histos.add("hPtEtaNoCut", "before track selection;#it{p}_{T} (GeV/#it{c});#eta", kTH2D, {{axisPtEl}, {40, -1., 1.}});
    histos.add("hPtCrossedRowsTpcNoCut", "before track selection;#it{p}_{T} (GeV/#it{c});TPC crossed rows", kTH2D, {{axisPtEl}, {165, -0.5, 164.5}});
    histos.add("hPtCrossedRowsOverFindableTpcNoCut", "before track selection;#it{p}_{T} (GeV/#it{c});TPC crossed rows / findable clusters", kTH2D, {{axisPtEl}, {200, 0., 2.}});
    histos.add("hPtNClsFoundTpcNoCut", "before track selection;#it{p}_{T} (GeV/#it{c});TPC found clusters", kTH2D, {{axisPtEl}, {165, -0.5, 164.5}});
    histos.add("hPtNClsFindableTpcNoCut", "before track selection;#it{p}_{T} (GeV/#it{c});TPC findable clusters", kTH2D, {{axisPtEl}, {165, -0.5, 164.5}});
    histos.add("hPtFoundOverFindableTpcNoCut", "before track selection;#it{p}_{T} (GeV/#it{c});TPC found / findable clusters", kTH2D, {{axisPtEl}, {200, 0., 2.}});
    histos.add("hPtFracSharedClsTpcNoCut", "before track selection;#it{p}_{T} (GeV/#it{c});fraction of shared TPC clusters", kTH2D, {{axisPtEl}, {100, 0., 1.}});
    histos.add("hPtChi2TpcNoCut", "before track selection;#it{p}_{T} (GeV/#it{c});#chi^{2} / cluster TPC", kTH2D, {{axisPtEl}, {100, 0., 10.}});
    histos.add("hPtNClsItsNoCut", "before track selection;#it{p}_{T} (GeV/#it{c});# clusters ITS", kTH2D, {{axisPtEl}, {8, -0.5, 7.5}});
    histos.add("hPtIbClsItsNoCut", "before track selection;#it{p}_{T} (GeV/#it{c});# clusters ITS inner barrel", kTH2D, {{axisPtEl}, {4, -0.5, 3.5}});
    histos.add("hPtChi2ItsNoCut", "before track selection;#it{p}_{T} (GeV/#it{c});#chi^{2} / cluster ITS", kTH2D, {{axisPtEl}, {100, 0., 40.}});
    histos.add("hPtDcaXYNoCut", "before track selection;#it{p}_{T} (GeV/#it{c});DCA_{xy} (cm)", kTH2D, {{axisPtEl}, {600, -3., 3.}});
    histos.add("hPtDcaZNoCut", "before track selection;#it{p}_{T} (GeV/#it{c});DCA_{z} (cm)", kTH2D, {{axisPtEl}, {600, -3., 3.}});
  ...
  void fillTrackQaNoCut(const TrackType& track)
  {
    double const pt = track.pt();
    histos.fill(HIST("hPtEtaNoCut"), pt, track.eta());
    histos.fill(HIST("hPtCrossedRowsTpcNoCut"), pt, track.tpcNClsCrossedRows());
    histos.fill(HIST("hPtCrossedRowsOverFindableTpcNoCut"), pt, track.tpcCrossedRowsOverFindableCls());
    histos.fill(HIST("hPtNClsFoundTpcNoCut"), pt, track.tpcNClsFound());
    histos.fill(HIST("hPtNClsFindableTpcNoCut"), pt, track.tpcNClsFindable());
    histos.fill(HIST("hPtFoundOverFindableTpcNoCut"), pt, track.tpcFoundOverFindableCls());
    histos.fill(HIST("hPtFracSharedClsTpcNoCut"), pt, track.tpcFractionSharedCls());
    histos.fill(HIST("hPtChi2TpcNoCut"), pt, track.tpcChi2NCl());
    histos.fill(HIST("hPtNClsItsNoCut"), pt, track.itsNCls());
    histos.fill(HIST("hPtIbClsItsNoCut"), pt, track.itsNClsInnerBarrel());
    histos.fill(HIST("hPtChi2ItsNoCut"), pt, track.itsChi2NCl());
    histos.fill(HIST("hPtDcaXYNoCut"), pt, track.dcaXY());
    histos.fill(HIST("hPtDcaZNoCut"), pt, track.dcaZ());
  }
